//
//  InfixOperatorMinus.swift
//  MMExpressionSolver
//

import Foundation

/// Infix-operator _Minus_
///
/// Calculates `value1 - value2`.
///
/// This left-assiciative operator performs minus-operation for numeric types.
///
/// When at least one of operands has `nil`-value the result will be `nil`.
///
/// @Small { Available since <doc:MMExpressionSolver-Release-History#Release-1.0.0>. }
public final class InfixOperatorMinus: ExpressionOperator {
    ...
    public var id: OperatorIdentifier { get { OperatorIdentifier("InfixOperatorMinus") } }
    ...
    public var symbols: [String] { get { [InfixOperatorMinus.symbolOperator] } }
    ...
    public var description: String {
        return InfixOperatorMinus.symbolOperator
    }

    // MARK: - Protocol CustomDebugStringConvertible

    public var debugDescription: String {
        return "InfixOperatorMinus()"
    }
