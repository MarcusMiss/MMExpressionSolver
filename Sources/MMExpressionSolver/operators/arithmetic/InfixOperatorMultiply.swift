    ...
    public func evaluateOperator(context: any ExpressionEvaluationContext,
        ...
        if p1.isNumericValue && p2.isNumericValue {
            ...
            if p1.isUnitArea {          // Physical dimension
                return ExpressionValue.of(scalar * p1.asUnitArea()!)
            } else if p1.isUnitLength {
                return ExpressionValue.of(scalar * p1.asUnitLength()!)
            } else if p1.isUnitVolume {
                return ExpressionValue.of(scalar * p1.asUnitVolume()!)
            } else if p1.isUnitAngle {
                return ExpressionValue.of(scalar * p1.asUnitAngle()!)
            } else if p1.isUnitMass {   // Mass, Weight, and Force
                return ExpressionValue.of(scalar * p1.asUnitMass()!)
            } else if p1.isUnitPressure {
                return ExpressionValue.of(scalar * p1.asUnitPressure()!)
            } else if p1.isUnitAcceleration { // Time and Motion
                return ExpressionValue.of(scalar * p1.asUnitAcceleration()!)
            } else if p1.isUnitDuration {
                return ExpressionValue.of(scalar * p1.asUnitDuration()!)
            } else if p1.isUnitFrequency {
                return ExpressionValue.of(scalar * p1.asUnitFrequency()!)
            } else if p1.isUnitSpeed {
                return ExpressionValue.of(scalar * p1.asUnitSpeed()!)
            } else if p1.isUnitEnergy { // Energy, Heat and Light
                return ExpressionValue.of(scalar * p1.asUnitEnergy()!)
            } else if p1.isUnitPower {
                return ExpressionValue.of(scalar * p1.asUnitPower()!)
            } else if p1.isUnitTemperatur {
                return ExpressionValue.of(scalar * p1.asUnitTemperature()!)
            } else if p1.isUnitIlluminance {
                return ExpressionValue.of(scalar * p1.asUnitIlluminance()!)
            } else if p1.isUnitElectricCharge { // Electricity
                return ExpressionValue.of(scalar * p1.asUnitElectricCharge()!)
            } else if p1.isUnitElectricCurrent {
                return ExpressionValue.of(scalar * p1.asUnitElectricCurrent()!)
            } else if p1.isUnitElectricPotentialDifference {
                return ExpressionValue.of(scalar * p1.asUnitElectricPotentialDifference()!)
            } else if p1.isUnitElectricResistance {
                return ExpressionValue.of(scalar * p1.asUnitElectricResistence()!)
            } else if p1.isUnitConcentrationMass { // Misc
                return ExpressionValue.of(scalar * p1.asUnitConcentrationMass()!)
            } else if p1.isUnitDispersion {
                return ExpressionValue.of(scalar * p1.asUnitDispersion()!)
            } else if p1.isUnitFuelEfficiency {
                return ExpressionValue.of(scalar * p1.asUnitFuelEfficiency()!)
            } else if p1.isUnitInformationStorage {
                return ExpressionValue.of(scalar * p1.asUnitInformationStorage()!)
            }
        }
