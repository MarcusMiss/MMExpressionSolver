...
///
/// This left-assiciative operator performs OR-operation for boolean types.
///
/// When at least one of operands has `nil`-value the result will be `nil`.
///
/// @Small { Available since <doc:MMExpressionSolver-Release-History#Release-1.0.0>. }
public final class InfixOperatorOr: ExpressionOperator {
    ...
    public var id: OperatorIdentifier { get { OperatorIdentifier("InfixOperatorOr") } }
    ...
    public var symbols: [String] { get { [InfixOperatorOr.symbolOperator , "OR"] } }
