//
//  InfixOperatorAnd.swift
//  MMExpressionSolver
//

import Foundation

/// Infix-operator _AND_
///
/// Calculates `value1 && value2`.
///
/// This left-assiciative operator performs AND-operation for boolean types.
///
/// When at least one of operands has `nil`-value the result will be `nil`.
///
/// @Small { Available since <doc:MMExpressionSolver-Release-History#Release-1.0.0>. }
public final class InfixOperatorAnd: ExpressionOperator {
    ...
    public var id: OperatorIdentifier { get { OperatorIdentifier("InfixOperatorAnd") } }
    ...
    public var symbols: [String] { get { [InfixOperatorAnd.symbolOperator , "AND"] } }
    ...
    public var description: String {
        return InfixOperatorAnd.symbolOperator
    }

    // MARK: - Protocol CustomDebugStringConvertible

    public var debugDescription: String {
        return "InfixOperatorAnd()"
    }
