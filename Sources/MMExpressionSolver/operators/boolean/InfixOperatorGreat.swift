...
public final class InfixOperatorGreat: ExpressionOperator {
    ...
    public var id: OperatorIdentifier { get { OperatorIdentifier("InfixOperatorGreat") } }
    ...
    public var symbols: [String] { get { [InfixOperatorGreat.symbolOperator] } }
    ...
    public var description: String {
        return InfixOperatorGreat.symbolOperator
    }

    // MARK: - Protocol CustomDebugStringConvertible

    public var debugDescription: String {
        return "InfixOperatorGreat()"
    }
