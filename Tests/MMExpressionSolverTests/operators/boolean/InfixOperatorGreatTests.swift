...
@Suite("InfixOperator >")
class InfixOperatorGreatTests {
    
    @Test("Operator > definition")
    func operatorDefinition() async throws {
        let op: InfixOperatorGreat = InfixOperatorGreat()
        #expect(op.id == OperatorIdentifier("InfixOperatorGreat"))
        #expect(op.symbols == [">"])
