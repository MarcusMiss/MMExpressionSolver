//
//  PrefixOperatorMinusTests.swift
//  MMExpressionSolver
//
...
@Suite("PrefixOperatorMinus")
class PrefixOperatorMinusTests {

    @Test("Operator - definition")
    func operatorDefinition() async throws {
        let op: PrefixOperatorMinus = PrefixOperatorMinus()
        #expect(op.id == OperatorIdentifier("PrefixOperatorMinus"))
        #expect(op.symbols == ["-"])
    ...
    func evaluateOperatorToFail() async throws {
        ...
        print("1:error=\(String(describing: error1))")
    }
