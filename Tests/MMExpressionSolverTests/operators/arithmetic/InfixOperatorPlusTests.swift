...
class InfixOperatorPlusTests {
    ...
    func evaluateOperator() async throws {
        ...
        try #require(result.asUnitArea() == Measurement<UnitArea>(value: 300.0, unit: .squareCentimeters))
        // 09: UnitLength + UnitLength
        result = try op.evaluateOperator(context: ctxt, operatorToken: mockToken, arguments: [
        ...
        try #require(result.asUnitLength() == Measurement<UnitLength>(value: 300.0, unit: .kilometers))
        // 10: UnitVolume + UnitVolume
        result = try op.evaluateOperator(context: ctxt, operatorToken: mockToken, arguments: [
        ...
        try #require(result.asUnitVolume() == Measurement<UnitVolume>(value: 300.0, unit: .cubicMeters))
        // 11: UnitAngle + UnitAngle
        result = try op.evaluateOperator(context: ctxt, operatorToken: mockToken, arguments: [
        ...
        try #require(result.asUnitAngle() == Measurement<UnitAngle>(value: 270.0, unit: .degrees))
        // 12: UnitMass + UnitMass
        result = try op.evaluateOperator(context: ctxt, operatorToken: mockToken, arguments: [
        ...
        try #require(result.asUnitMass() == Measurement<UnitMass>(value: 270.0, unit: .kilograms))
        // 13: UnitPressure + UnitPressure
        result = try op.evaluateOperator(context: ctxt, operatorToken: mockToken, arguments: [
        ...
        try #require(result.asUnitPressure() == Measurement<UnitPressure>(value: 270.0, unit: .bars))
        // 14: UnitAcceleration + UnitAcceleration
        result = try op.evaluateOperator(context: ctxt, operatorToken: mockToken, arguments: [
        ...
        try #require(result.asUnitAcceleration() == Measurement<UnitAcceleration>(value: 270.0, unit: .metersPerSecondSquared))
        // 15: UnitDuration + UnitDuration
        result = try op.evaluateOperator(context: ctxt, operatorToken: mockToken, arguments: [
        ...
        try #require(result.asUnitDuration() == Measurement<UnitDuration>(value: 270.0, unit: .seconds))
        ...
        try #require(result.asUnitFrequency() == Measurement<UnitFrequency>(value: 270.0, unit: .hertz))
        // 17: UnitFrequency + UnitFrequency
        result = try op.evaluateOperator(context: ctxt, operatorToken: mockToken, arguments: [
        ...
        try #require(result.asUnitSpeed() == Measurement<UnitSpeed>(value: 270.0, unit: .knots))
        // 18: UnitEnergy + UnitEnergy
        result = try op.evaluateOperator(context: ctxt, operatorToken: mockToken, arguments: [
        ...
        try #require(result.asUnitEnergy() == Measurement<UnitEnergy>(value: 270.0, unit: .kilowattHours))
        // 19: UnitPower + UnitPower
        result = try op.evaluateOperator(context: ctxt, operatorToken: mockToken, arguments: [
        ...
        try #require(result.asUnitPower() == Measurement<UnitPower>(value: 270.0, unit: .watts))
        // 20: UnitTemperature + UnitTemperature
        result = try op.evaluateOperator(context: ctxt, operatorToken: mockToken, arguments: [
        ...
        try #require(result.asUnitTemperature() == Measurement<UnitTemperature>(value: 270.0, unit: .kelvin))
        // 21: UnitTemperature + UnitTemperature
        result = try op.evaluateOperator(context: ctxt, operatorToken: mockToken, arguments: [
        ...
        try #require(result.asUnitIlluminance() == Measurement<UnitIlluminance>(value: 270.0, unit: .lux))
        // 22: UnitElectricCharge + UnitElectricCharge
        result = try op.evaluateOperator(context: ctxt, operatorToken: mockToken, arguments: [
        ...
        try #require(result.asUnitElectricCharge() == Measurement<UnitElectricCharge>(value: 270.0, unit: .ampereHours))
        // 23: UnitElectricCurrent + UnitElectricCurrent
        result = try op.evaluateOperator(context: ctxt, operatorToken: mockToken, arguments: [
        ...
        try #require(result.asUnitElectricCurrent() == Measurement<UnitElectricCurrent>(value: 270.0, unit: .amperes))
        // 24: UnitElectricPotentialDifference + UnitElectricPotentialDifference
        result = try op.evaluateOperator(context: ctxt, operatorToken: mockToken, arguments: [
        ...
        try #require(result.asUnitElectricPotentialDifference() == Measurement<UnitElectricPotentialDifference>(value: 270.0, unit: .volts))
        ...
        try #require(result.asUnitElectricResistence() == Measurement<UnitElectricResistance>(value: 270.0, unit: .ohms))
        ...
        try #require(result.asUnitConcentrationMass() == Measurement<UnitConcentrationMass>(value: 270.0, unit: .gramsPerLiter))
        ...
        try #require(result.asUnitDispersion() == Measurement<UnitDispersion>(value: 270.0, unit: .partsPerMillion))
        ...
        try #require(result.asUnitFuelEfficiency() == Measurement<UnitFuelEfficiency>(value: 270.0, unit: .litersPer100Kilometers))
        ...
        try #require(result.asUnitInformationStorage() == Measurement<UnitInformationStorage>(value: 270.0, unit: .bits))
    }
