...
@Suite("Function SEC()")
class FunctionSECTests {

    @Test("Definition of COSEC()")
    func validateInit() async throws {
        let f: FunctionSEC = FunctionSEC()
        #expect(f.id == FunctionIdentifier("FunctionSEC"))
        #expect(f.symbols == ["SEC"])
        #expect(f.definition == ExpressionFunctionDefinition(name: "SEC", parameters:[
    ...
    func validateSuccess() async throws {
        ...
        #expect(evalValue.asDouble()! == Double(1.8508157176809255))
    }
