...
@Suite("Function ASECH()")
class FunctionASECHTests {

    @Test("Definition of ASECH()")
    func validateInit() async throws {
        let f: FunctionASECH = FunctionASECH()
        #expect(f.id == FunctionIdentifier("FunctionASECH"))
        #expect(f.symbols == ["ASECH"])
        #expect(f.definition == ExpressionFunctionDefinition(name: "ASECH", parameters:[
    ...
    func evaluateInExpression(expressionSource: String) async throws {
        ...
        context.variables.storeVariable(identifier: "var2", value: ExpressionValue.of((Double(0.5))))
        context.variables.storeVariable(identifier: "var3", value: ExpressionValue.of((Float(0.5))))
        context.variables.storeVariable(identifier: "var4", value: ExpressionValue.of((Decimal(0.5))))
    ...
    func validateSuccess() async throws {
        let expression: String = "ASECH(1.0)"
        let config: ExpressionConfiguration = ExpressionConfiguration.createDefault()
