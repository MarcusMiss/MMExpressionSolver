...
@Suite("Function SINH()")
class FunctionSINHTests {

    @Test("Definition of SINH()")
    func validateInit() async throws {
        let f: FunctionSINH = FunctionSINH()
    ...
    func validateSuccess() async throws {
        let expression: String = "SINH(1.0)"
        let config: ExpressionConfiguration = ExpressionConfiguration.createDefault()
        ...
        #expect(evalValue.asDouble()! == Double(1.1752011936438014))
    }
