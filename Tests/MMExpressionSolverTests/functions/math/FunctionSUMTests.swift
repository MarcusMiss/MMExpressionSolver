...
@Suite("Function SUM()")
class FunctionSUMTests {

    @Test("Definition of SUM()")
    func validateInit() async throws {
        let f: FunctionSUM = FunctionSUM()
        #expect(f.id == FunctionIdentifier("FunctionSUM"))
        #expect(f.symbols == ["SUM"])
        #expect(f.definition == ExpressionFunctionDefinition(name: "SUM", parameters:[
    ...
    @Test("Function evaluation in expression-context",
        arguments: [
          ...
          "SUM(10, 20)",
          "SUM(var1, 20)",
          "SUM(var2, 1000, -100, 2000)",
          "SUM(var3, 100)",
          "SUM(var4, var3, var2, var1)",
        ]
    )
    ...
    func validateSuccess() async throws {
        let expression: String = "SUM(10.0, 20.0, 30.0)"
        let config: ExpressionConfiguration = ExpressionConfiguration.createDefault()
        ...
        #expect(evalValue.asDecimal()! == Decimal(60.0))
    }
