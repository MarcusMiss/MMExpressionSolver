...
@Suite("Function UPPER()")
class FunctionUPPERTests {

    @Test("Definition of UPPER()")
    func validateInit() async throws {
        let f: FunctionUPPER = FunctionUPPER()
        #expect(f.id == FunctionIdentifier("FunctionUPPER"))
        #expect(f.symbols == ["UPPER"])
        #expect(f.definition == ExpressionFunctionDefinition(name: "UPPER", parameters:[
    ...
    func validateSuccess() async throws {
        let expression: String = "UPPER('Lorem Ipsum')"
        let config: ExpressionConfiguration = ExpressionConfiguration.createDefault()
