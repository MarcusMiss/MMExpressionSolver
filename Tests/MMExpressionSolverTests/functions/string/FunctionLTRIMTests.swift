...
@Suite("Function LTRIM()")
class FunctionLTRIMTests {

    @Test("Definition of LTRIM()")
    func validateInit() async throws {
        let f: FunctionLTRIM = FunctionLTRIM()
        #expect(f.id == FunctionIdentifier("FunctionLTRIM"))
        #expect(f.symbols == ["LTRIM"])
        #expect(f.definition == ExpressionFunctionDefinition(name: "LTRIM", parameters:[
    ...
    func validateSuccess() async throws {
        let expression: String = "LTRIM('   Lorem   ')"
        let config: ExpressionConfiguration = ExpressionConfiguration.createDefault()
