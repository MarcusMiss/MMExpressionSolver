...
class FunctionTRIMPREFIXTests {
    ...
    func validateInit() async throws {
        ...
        #expect(f.id == FunctionIdentifier("FunctionTRIMPREFIX"))
        #expect(f.symbols == ["TRIMPREFIX"])
        #expect(f.definition == ExpressionFunctionDefinition(name: "FunctionTRIMPREFIX", parameters:[
    ...
    func evaluateFunction() async throws {
        ...
        // 02: TRIMPREFIX(string, null) (null)
        result = try f.evaluateFunction(expression: fake.get(),
                                        context: ctxt,
                                        functionToken: mockToken,
        ...
        try #require(result.isNullValue == true)
        // 03: TRIMPREFIX(string, string) (string)
        result = try f.evaluateFunction(expression: fake.get(),
                                        context: ctxt,
                                        functionToken: mockToken,
        ...
        try #require(result.asString() == "rem")
    }
    ...
    @Test("Function evaluation in expression-context",
        arguments: [
          "TRIMPREFIX(\"  \", \" \")",
          "TRIMPREFIX(\"  Ipsum  \", \" \")",
          "TRIMPREFIX(var1, var1)",
          "TRIMPREFIX(NULL, var1)",
          "TRIMPREFIX(\"Ipsum\", \"xxx\")",
        ]
    )
    ...
    func validateSuccess() async throws {
        let expression: String = "TRIMPREFIX('Lorem Ipsum', 'Lorem')"
        let config: ExpressionConfiguration = ExpressionConfiguration.createDefault()
