...
class FunctionNOWTests {
    ...
    @Test("Definition of NOW()")
    func validateInit() async throws {
        let f: FunctionNOW = FunctionNOW()
        #expect(f.id == FunctionIdentifier("FunctionNOW"))
        #expect(f.symbols == ["NOW"])
        #expect(f.definition == ExpressionFunctionDefinition(name: "NOW", parameters:[]))
