//
//  FunctionUNITACCELERATIONTests.swift
//  MMExpressionSolver
//
...
@Suite("Function UNITACCELERATION()")
class FunctionUNITACCELERATIONTests {

    @Test("solveUnitSymbol of UNITACCELERATION()")
    func solveUnitSymbol() async throws {
        try #require(FunctionUNITACCELERATION.solveUnitSymbol("m/s²")! == .metersPerSecondSquared)
        try #require(FunctionUNITACCELERATION.solveUnitSymbol("g")! == .gravity)
    }

    @Test("Definition of UNITACCELERATION()")
    func validateInit() async throws {
        let f: FunctionUNITACCELERATION = FunctionUNITACCELERATION()
        #expect(f.id == FunctionIdentifier("FunctionUNITACCELERATION"))
        #expect(f.symbols == ["UNITACCELERATION"])
        #expect(f.definition == ExpressionFunctionDefinition(name: "UNITACCELERATION", parameters:[
    ...
    @Test("Function evaluation in expression-context",
        arguments: [
          "UNITACCELERATION(10, 'g')",
          "UNITACCELERATION(var1, 'm/s²')",
        ]
    )
    ...
    @Test("Function evaluation in expression-context",
        arguments: [
            "UNITACCELERATION(NULL, 'murks')",
            "UNITACCELERATION(20.0, \"murks\")",
            "UNITACCELERATION(var1, var1)",
        ]
    )
    ...
    func validateSuccess() async throws {
        let expression: String = "UNITACCELERATION(100.0, \"m/s²\")"
        let config: ExpressionConfiguration = ExpressionConfiguration.createDefault()
        let context: ExpressionEvaluationContextImpl = ExpressionEvaluationContextImpl(configuration: config)
        let result: Result<MMExpression, ExpressionError> = MMExpression.build(
        ...
        #expect(evalValue.isUnitAcceleration)
        #expect(evalValue.asUnitAcceleration()! == Measurement<UnitAcceleration>(value: 100.0, unit: .metersPerSecondSquared))
    }
