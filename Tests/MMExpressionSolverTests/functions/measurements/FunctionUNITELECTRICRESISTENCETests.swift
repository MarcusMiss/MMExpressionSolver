//
//  FunctionUNITELECTRICRESISTENCETests.swift
//  MMExpressionSolver
//
...
class FunctionUNITELECTRICRESISTENCETests {

    @Test("solveUnitSymbol of UNITELECTRICRESISTENCE()")
    func solveUnitSymbol() async throws {
        try #require(FunctionUNITELECTRICRESISTENCE.solveUnitSymbol("MΩ")! == .megaohms)
        try #require(FunctionUNITELECTRICRESISTENCE.solveUnitSymbol("kΩ")! == .kiloohms)
        try #require(FunctionUNITELECTRICRESISTENCE.solveUnitSymbol("Ω")! == .ohms)
        try #require(FunctionUNITELECTRICRESISTENCE.solveUnitSymbol("mΩ")! == .milliohms)
        try #require(FunctionUNITELECTRICRESISTENCE.solveUnitSymbol("µΩ")! == .microohms)
    }

    @Test("Definition of UNITELECTRICRESISTENCE()")
    func validateInit() async throws {
        let f: FunctionUNITELECTRICRESISTENCE = FunctionUNITELECTRICRESISTENCE()
        #expect(f.id == FunctionIdentifier("FunctionUNITELECTRICRESISTENCE"))
        #expect(f.symbols == ["UNITELECTRICRESISTENCE"])
        #expect(f.definition == ExpressionFunctionDefinition(name: "UNITELECTRICRESISTENCE", parameters:[
    ...
    @Test("Function evaluation in expression-context",
        arguments: [
          "UNITELECTRICRESISTENCE(10, 'kΩ')",
          "UNITELECTRICRESISTENCE(var1, 'mΩ')",
        ]
    )
    ...
    @Test("Function evaluation in expression-context",
        arguments: [
            "UNITELECTRICRESISTENCE()",
            "UNITELECTRICRESISTENCE(10, 'xx', 20)",
        ]
    )
    ...
    @Test("Function evaluation in expression-context",
        arguments: [
            "UNITELECTRICRESISTENCE(NULL, 'murks')",
            "UNITELECTRICRESISTENCE(20.0, \"murks\")",
            "UNITELECTRICRESISTENCE(var1, var1)",
        ]
    )
    ...
    func validateSuccess() async throws {
        let expression: String = "UNITELECTRICRESISTENCE(100.0, \"Ω\")"
        let config: ExpressionConfiguration = ExpressionConfiguration.createDefault()
        let context: ExpressionEvaluationContextImpl = ExpressionEvaluationContextImpl(configuration: config)
        let result: Result<MMExpression, ExpressionError> = MMExpression.build(
        ...
        #expect(evalValue.isUnitElectricResistance)
        #expect(evalValue.asUnitElectricResistence()! == Measurement<UnitElectricResistance>(value: 100.0, unit: .ohms))
    }
