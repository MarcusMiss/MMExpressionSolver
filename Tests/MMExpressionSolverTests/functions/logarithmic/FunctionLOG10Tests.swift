...
@Suite("Function LOG10()")
class FunctionLOG10Tests {

    @Test("Definition of LOG()")
    func validateInit() async throws {
        let f: FunctionLOG10 = FunctionLOG10()
        #expect(f.id == FunctionIdentifier("FunctionLOG10"))
        #expect(f.symbols == ["LOG10"])
        #expect(f.definition == ExpressionFunctionDefinition(name: "LOG10", parameters:[
    ...
    func validateSuccess() async throws {
        let expression: String = "LOG10(100)"
        let config: ExpressionConfiguration = ExpressionConfiguration.createDefault()
